...
public interface ArgumentParser {
    ...
    /**
     * Parses the argument at the position given and transforms it into an instance of the given type.
     *
     ...
     * @throw InvalidArgumentException if the argument at the given position cannot be parsed to the type given type.
     * (Independently of the reason why it couldn't be parsed).
     */
